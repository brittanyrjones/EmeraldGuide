...
public class Hygiene {
    ...
    public Hygiene(String area, String hygieneAddress, String category, String hygieneName, String phoneNumber, String website, String hygieneInformation, String hygieneHours) {
        super();
        this.area = area;
